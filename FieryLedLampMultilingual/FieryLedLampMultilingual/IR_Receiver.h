...
#define IR_EQ          0x00000012 // Эквалайзер
#define IR_TIME        0xFFB04F // "CLOCK"      Сказать/показать время
#define IR_VOL_DOWN    0xFFA857 // "VOL-"       Уменьшить громкость
#define IR_VOL_UP      0xFF906F // "VOL+"       Увеличить громкость
#define IR_IP          0xFF9867 // "PRT"        Показать IP адрес
#define IR_BR_UP       0xFF22DD // "Start/Pause" Увеличить яркость
#define IR_BR_DOWN     0xFFE01F // "EQ"         Уменьшить яркость
#define IR_SP_UP       0x00000015 // Увеличить скорость
#define IR_SP_DOWN     0x00000016 // Уменьшить скорость
#define IR_SC_UP       0x00000017 // Увеличить масштаб
#define IR_SC_DOWN     0x00000018 // Уменьшить масштаб
#define IR_FAV_ADD     0x00000019 // Добавить в избранное
#define IR_FAV_DEL     0x0000001A // Удалить из избранного
#define IR_RND         0x0000001B // Случайные настр. текущего эфф.
#define IR_DEF         0x0000001C // Настр. тек. эфф. по  умолчанию
#define IR_FOLD_PREV   0x0000001D // "FL-"        Предыдущая пепка
#define IR_FOLD_NEXT   0x0000001E // "FL+"        Следующая папка
#define IR_1           0xFF30CF // "1"
#define IR_2           0xFF18E7 // "2"
#define IR_3           0xFF7A85 // "3"
#define IR_4           0xFF10EF // "4"
#define IR_5           0xFF38C7 // "5"
#define IR_6           0xFF5AA5 // "6"
#define IR_7           0xFF42BD // "7"
#define IR_8           0xFF4AB5 // "8"
#define IR_9           0xFF52AD // "9"
#define IR_0           0xFF6897 // "0"
