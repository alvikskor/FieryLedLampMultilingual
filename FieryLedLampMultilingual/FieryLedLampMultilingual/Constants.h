// Поточна версія / Current version : v3.80_sound_Multilingual_IR 112 ефектов
...
#define FLL_VERSION           (" Ver.3.80.112")
...
#define USE_LittleFS                                        // Закомментируйте эту строку, если вместо файловой системы LittlFS  хотите использовать файловую систему SPIFFS (застаріла)
...
#define MOSFET_PIN            (33U)                         // пин MOSFET транзистора - может быть использован для управления питанием матрицы/ленты (если раскомментировать строку)
...
//#define ALARM_PIN             (39U)                       // пин состояния будильника - может быть использован для управления каким-либо внешним устройством на время работы будильника (если раскомментировать)
...
#define MP3_PLAYER_USE                                      // В СЛУЧАЕ ОТСУТСТВИЯ ПЛЕЕРА ЗАКОМЕНТМРОВАТЬ СТРОКУ!!!
#ifdef MP3_PLAYER_USE
 #define MP3_TX_PIN            (25U)                        // Определяет вывод TX (RX на плеере)  
 #define MP3_RX_PIN            (26U)                        // Определяет вывод RX (TX на плеере) программного последовательного порта
...
#define MP3_PLAYER_USE                                      // В СЛУЧАЕ ОТСУТСТВИЯ ПЛЕЕРА ЗАКОМЕНТМРОВАТЬ СТРОКУ!!!
#ifdef MP3_PLAYER_USE
 #define MP3_TX_PIN            (12U)                        // Определяет вывод TX (D6)(RX на плеере)  
