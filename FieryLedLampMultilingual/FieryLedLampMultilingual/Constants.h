// Поточна версія / Current version : v3.95_sound_Multilingual_IR 112 ефектов
...
#define FLL_VERSION           (" Ver.3.95.112")
#define FLL_MARK              (395)
...
// --- МАТРИЦЯ -------------------------
#define CURRENT_LIMIT         (4000U)                       // Можна встановити значення від 0 до 65535. Ліміт споживання матриці по струму в міліамперах, автоматично управляє яскравістю (пожалій свій блок живлення!) 0 - вимкнути ліміт
